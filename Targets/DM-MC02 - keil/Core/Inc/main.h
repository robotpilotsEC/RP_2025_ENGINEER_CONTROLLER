...
#define SELF_BUTTON_Pin GPIO_PIN_0
#define SELF_BUTTON_GPIO_Port GPIOA
#define LEVEL4_BUTTON_Pin GPIO_PIN_2
#define LEVEL4_BUTTON_GPIO_Port GPIOA
...
#define LEVEL3_BUTTON_Pin GPIO_PIN_9
#define LEVEL3_BUTTON_GPIO_Port GPIOE
